...
//    SKAction * soundEffect = [SKAction playSoundFileNamed:@"jump.wav" waitForCompletion:NO];
//    
...
- (IBAction)attackButtonPressed:(UIButton *)sender {
    ...
    if ([sender.titleLabel.text isEqualToString:@"2"]) {
        ...
        [scene specialAttack];
        [SKAction playSoundFileNamed:@"fire.wav" waitForCompletion:true];
